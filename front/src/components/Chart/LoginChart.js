...
export default function GenderPieChart () {
    ...
    const changeMonth = e => {
        setSelectMonth({...selectMonth, "key":e.target.value, "month":month[parseInt(e.target.value)]})
        console.log(selectMonth);
        console.log(loginTime.selectMonth)
      }
    ...
    const config = {
        ...
        options: {
            ...
            dataLabels: {
              ...
              xaxis: {
                categories: ['08H', '09H', '10H', '11H', '12H', '13H', '14H', '15H', '16H', '17H', '18H', '19H', '20H', '21H', '22H', '23H']
              }
          }
      }

      const getLoginTime = async() => {
        await axios.get("http://localhost:80/getLoginTime")
          .then(
            data => {
