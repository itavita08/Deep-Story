...
import LogoutHeadr from "../Header/LogoutHeader";
import Card from "../CardGroup/Card";
import { useLocation } from "react-router-dom";

function SearchResultLogoutComponent(props) {
...
export default React.memo(SearchResultLogoutComponent);
