...
import io.playdata.lo.dao.AccountRepository;
import io.playdata.lo.exception.BadRequestException;
import io.playdata.lo.model.domain.AccountEntity;
import io.playdata.lo.model.dto.AccountDTO;
import io.playdata.lo.model.dto.LoginRequestDTO;
import io.playdata.lo.model.dto.SignUpRequestDTO;
...
public class AccountService {
	...
	public AccountDTO signUp(SignUpRequestDTO signUpRequest) {
		...
		AccountEntity account = AccountEntity.builder().accountEmail(signUpRequest.getAccountEmail()).accountName(signUpRequest.getAccountName()).accountPassword(signUpRequest.getAccountPassword()).accountDate(signUpRequest.getAccountDate()).accountGender(signUpRequest.getAccountGender()).accountType("user").build();
