...
import io.deepstory.model.repository.SecretFreindsRepository;
...
public class SecretService {
	...
	@Autowired
	private SecretFreindsRepository secretFreindsRepository;
	...
	public Integer addSecretImage(SecretImageDTO newImage) throws Exception {
		...
		SecretImageEntity imageEntity = SecretImageEntity.builder().secretImageName(newImage.getSecretImageName())
